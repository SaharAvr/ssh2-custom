...
const { Ber } = require(__nodeModulesDir + 'asn1');
const bcrypt_pbkdf = require(__nodeModulesDir + 'bcrypt-pbkdf').pbkdf;

const { CIPHER_INFO } = require(__nodeModulesDir + 'ssh2/lib/protocol/crypto.js');
const { eddsaSupported, SUPPORTED_CIPHER } = require(__nodeModulesDir + 'ssh2/lib/protocol/constants.js');
const {
  bufferSlice,
  makeBufferParser,
  readString,
