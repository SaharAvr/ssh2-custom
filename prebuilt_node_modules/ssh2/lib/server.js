...
const { Server: netServer } = require('node:net');
...
} = require(__nodeModulesDir + 'ssh2/lib/protocol/constants.js');
const { init: cryptoInit } = require(__nodeModulesDir + 'ssh2/lib/protocol/crypto.js');
const { KexInit } = require(__nodeModulesDir + 'ssh2/lib/protocol/kex.js');
const { parseKey } = require(__nodeModulesDir + 'ssh2/lib/protocol/keyParser.js');
const Protocol = require(__nodeModulesDir + 'ssh2/lib/protocol/Protocol.js');
const { SFTP } = require(__nodeModulesDir + 'ssh2/lib/protocol/SFTP.js');
const { writeUInt32BE } = require(__nodeModulesDir + 'ssh2/lib/protocol/utils.js');
...
const {
  ...
  windowAdjust,
  WINDOW_THRESHOLD,
} = require(__nodeModulesDir + 'ssh2/lib/Channel.js');
...
const {
  ...
  onCHANNEL_CLOSE,
} = require(__nodeModulesDir + 'ssh2/lib/utils.js');
